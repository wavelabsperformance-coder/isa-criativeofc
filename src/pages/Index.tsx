    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <motion.p
          ...
          className="mt-6 text-base text-muted-foreground md:text-lg max-w-2xl mx-auto"
        >
        ...
        <div className="grid items-center gap-12 md:grid-cols-2 md:gap-16">
          <AnimatedSection>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                A video editor specializing in visual effects and animation. I create
                high-impact visual content for marketing campaigns, music videos,
                YouTube channels and social media.
              </p>

              <p>
                With a background in advertising, I bring a strategic and creative
